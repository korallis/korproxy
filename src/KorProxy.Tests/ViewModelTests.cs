...
public class ViewModelTests
{
    ...
    public void ProxyStatus_ReflectsStateCorrectly()
    {
        ...
        var runningStatus = new ProxyStatus(ProxyState.Running, 1234, DateTimeOffset.UtcNow, "http://127.0.0.1:8317", 0, null);
        ...
        Assert.Equal("http://127.0.0.1:8317", runningStatus.EndpointUrl);
